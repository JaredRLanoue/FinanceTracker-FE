...
import {
    Box,
    Button, Center, Flex, IconButton, Select,
    Table, TableCaption,
    Tbody,
    Td,
    Text,
    ...
    return (
        <Box borderWidth="1px" borderRadius="lg" overflow="hidden" backgroundColor="white" p="4" boxShadow="lg"
            ...
            <Flex justify="space-between" align="center" mb="4">
                ...
                <Box>
                    <IconButton aria-label="Add Account" colorScheme="green" icon={<AddIcon/>} size="sm"
                    ...
                    {accounts.data && accounts.data.length > 0 ? (
                        accounts.data.map((account: Account) => (
                            <Tr key={account.id}>
                                ...
                                <Td>
                                    <IconButton aria-label="Edit" colorScheme="blue" icon={<EditIcon/>} size="sm"
                                                onClick={() => openEditAccountModal(account)} mr={2}/>
                                    <IconButton aria-label="Delete" colorScheme="red" icon={<DeleteIcon/>} size="sm"
                        ...
                        <Tr>
                            <Td colSpan={4}>
                                <Center>No accounts found... why not try adding some? 💰</Center>
                            </Td>
                        </Tr>
                    )}
                </Tbody>
            ...
            <NewAccountModal isOpen={newModalStatus} onClose={closeNewAccountModal}
                             setReloading={accounts.setReloading}/>
        </Box>
    );
}
